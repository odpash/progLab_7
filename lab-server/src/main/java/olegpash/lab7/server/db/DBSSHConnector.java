...
public class DBSSHConnector implements DBConnectable {
    ...
    public DBSSHConnector() {
        try {
            this.svLogin = "s335097";//System.getenv("SV_LOGIN");
            this.svPass = "dkp816";//System.getenv("SV_PASS");
            this.svAddr = "se.ifmo.ru";//System.getenv("SV_ADDR");
            this.forwardingPort = 5381;//Integer.parseInt(System.getenv("FORWARDING_PORT"));
            connectSSH();
            initializeDB();
